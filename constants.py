...
wzstaff_appeals = 'channelID' # appeals send channel
wzstaff_discussion = 'channelID' # reports discussion and commands channel
wz_submit = 'channelID' # reports submission channel
wz_appeals = 'channelID' # appeals submission channel
linked = 'roleID' # Minecraft linked role ID
srstaff = ['SrStaffRole1', 'SrStaffRole2'] # Sr. Mod and admin role IDs on staff server
